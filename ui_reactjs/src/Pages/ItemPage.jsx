...
import { CartCount, MainProductCard, ProductDetails,
    ProductImageCard, ProductOptions, 
    ProductPrice } from '../styledComponents/styledProductCart.style';
...
const ItemPage = ({item}) => {
    ...
    return(
        ...
        <ProductDetails>
            ...
            <div>
                <ProductPrice>
                    ₹ {item.price}{console.log("productName: ",item.productName)}
                </ProductPrice>
                <ProductOptions>
                    {(cartUpdate[item._id])?
                    <>
